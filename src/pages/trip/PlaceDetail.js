...
const PlaceDetail = () => {
	return (
		<div className="mx-auto p-4 font-['Pretendard']">
			<header className="text-center mb-8">
				<h1 className="text-xl font-semibold">관광지</h1>
			...
			<section className="mb-8">
				...
				<p className="text-gray-700">
					...
					인근의 깔끔한 편의시설이 있고 동해의 바닷물을 이용하여 온천을 즐길 수
					있는 해수온천이 있어 새로운 체험을 할 수 있고, 해수욕 입문 주차 공간과
					승용미 개방되어 있다. 또한, 모터보트, 바나나보트 등 수상 레저를 즐길
					수 있다.
				</p>
			</section>
