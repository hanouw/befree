...
const TripListDetailDateMoveModalComponent = ({
  ...
  return (
    <div>
      <div className="relative inline-block text-left mr-4 cursor-pointer">
        <div>
          <button
            type="button"
            className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-[Pretendard-Regular] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
            id="menu-button"
